...
{
    robo_entrega_async_web_server_cpp::WebsocketMessage m;
    m.type = robo_entrega_async_web_server_cpp::WebsocketMessage::type_text;
    m.content = content;
...
{
    robo_entrega_async_web_server_cpp::WebsocketMessage m;
    m.type = robo_entrega_async_web_server_cpp::WebsocketMessage::type_ping;
    m.content = content;
    return sendMessage(m);
}
